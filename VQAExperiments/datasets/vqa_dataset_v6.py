...
class VqaDataset(Dataset):  # dataset v6 RegNetY040 - FastText MS COCO V2
    ...
    def __getitem__(self, idx):
        if self.train:
            image_emb, question_emb, answer_emb = utils.get_train_index_regnety(idx)
        else:
            image_emb, question_emb, answer_emb = utils.get_validation_index_regnety(idx)
