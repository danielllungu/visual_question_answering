...
class VqaDataset(Dataset):  # dataset v4 ResNet50 - FastText MS COCO V2
    ...
    def __getitem__(self, idx):
        if self.train:
            image_emb, question_emb, answer_emb = utils.get_train_index_ms_coco_v2(idx)
        else:
            image_emb, question_emb, answer_emb = utils.get_validation_index_ms_coco_v2(idx)
