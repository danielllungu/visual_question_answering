...
from datasets.vqa_dataset_v1 import VQADataset
...
class VQANetwork(pl.LightningModule):
    def __init__(self):
        ...
        self.word2vec_model = utils.load_google_word2vec_model()
    ...
    def training_epoch_end(self, outputs):
        ...
        # avg_batch_accuracy = torch.mean(lst_accuracy_tensor)
...
if __name__ == '__main__':
    ...
    experiment_name = "VQA_exp_Word2Vec"
